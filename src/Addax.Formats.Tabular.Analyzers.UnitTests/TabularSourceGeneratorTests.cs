...
public sealed class TabularSourceGeneratorTests
{
    ...
    [DataRow("property-with-duplicate-field-indices.cs", 0, 1)]
    ...
    [DataRow("property-with-unsupported-type.cs", 0, 1)]
    [DataRow("property-with-unsupported-type-generic.cs", 0, 1)]
