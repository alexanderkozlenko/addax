...
/// <summary>Provides options to configure a tabular stream reader.</summary>
public sealed class TabularReaderOptions
{
    /// <summary>Initializes a new instance of the <see cref="TabularReaderOptions" /> class with optional arguments.</summary>
    ...
    public TabularReaderOptions(
        Encoding? encoding = null,
        int bufferSize = 4096,
        bool leaveOpen = false,
        bool consumeComments = false,
        TabularStringFactory? stringFactory = null,
