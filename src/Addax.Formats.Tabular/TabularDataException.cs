...
/// <summary>Represents an error that occurred during tabular data processing.</summary>
public sealed class TabularDataException : Exception
{
    ...
    /// <param name="position">The total number of characters processed before the error state.</param>
    ...
    /// <value>A non-negative zero-based <see cref="long" /> value.</value>
