...
/// <remarks>An instance of the generated record handler will be automatically added to the <see cref="TabularRegistry.Handlers" /> shared collection, which is used to resolve the required handler for reading and writing records. Use the <see cref="TabularFieldOrderAttribute" /> attribute to map a type member to a tabular field, and optional attributes <see cref="TabularFieldNameAttribute" /> and <see cref="TabularConverterAttribute{T}" /> to define a field name and apply a value converter.</remarks>
