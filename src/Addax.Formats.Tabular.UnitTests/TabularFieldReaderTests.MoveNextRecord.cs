...
{
    public static IEnumerable<object[]> MoveNextRecordWhenBeginningOfStreamData => TabularTestingFactory.ExpandDynamicData(
        new[]
        {
    ...
    [DataTestMethod, DynamicData(nameof(MoveNextRecordWhenBeginningOfStreamData))]
    public async Task MoveNextRecordWhenBeginningOfStream(string streamScript, bool expected, string dialectScript, string encodingName)
    {
        ...
        var result = await reader.MoveNextRecordAsync(CancellationToken);

        Assert.AreEqual(expected, result);
    }

    public static IEnumerable<object[]> MoveNextRecordWhenBeginningOfRecordData => TabularTestingFactory.ExpandDynamicData(
        new[]
        {
    ...
    [DataTestMethod, DynamicData(nameof(MoveNextRecordWhenBeginningOfRecordData))]
    public async Task MoveNextRecordWhenBeginningOfRecord(string streamScript, bool expected, string dialectScript, string encodingName)
    {
        var encoding = TabularTestingFactory.CreateEncoding(encodingName);
        var dialect = TabularTestingFactory.CreateDialect(dialectScript);
    ...
    public static IEnumerable<object[]> MoveNextRecordWhenFieldSeparationData => TabularTestingFactory.ExpandDynamicData(
        new[]
        {
            new object[] { "d", false, "lf-1a-1b-1c" },
            new object[] { "d", false, "lf-1a-1b-1b" },
            ...
            new object[] { "dd", false, "lf-1a-1b-1c" },
            new object[] { "dd", false, "lf-1a-1b-1b" },
            new object[] { "dd", false, "crlf-1a-1b-1c" },
            new object[] { "dd", false, "crlf-1a-1b-1b" },
    ...
    [DataTestMethod, DynamicData(nameof(MoveNextRecordWhenFieldSeparationData))]
    public async Task MoveNextRecordWhenFieldSeparation(string streamScript, bool expected, string dialectScript, string encodingName)
    {
        var encoding = TabularTestingFactory.CreateEncoding(encodingName);
        var dialect = TabularTestingFactory.CreateDialect(dialectScript);
        ...
        await reader.MoveNextRecordAsync(CancellationToken);
        await reader.MoveNextFieldAsync(CancellationToken);
    ...
    public static IEnumerable<object[]> MoveNextRecordWhenEndOfRecordData => TabularTestingFactory.ExpandDynamicData(
        new[]
        {
            new object[] { "l", true, "lf-1a-1b-1c" },
            new object[] { "l", true, "lf-1a-1b-1b" },
    ...
    [DataTestMethod, DynamicData(nameof(MoveNextRecordWhenEndOfRecordData))]
    public async Task MoveNextRecordWhenEndOfRecord(string streamScript, bool expected, string dialectScript, string encodingName)
    {
        var encoding = TabularTestingFactory.CreateEncoding(encodingName);
        var dialect = TabularTestingFactory.CreateDialect(dialectScript);
    ...
    public static IEnumerable<object[]> MoveNextRecordWhenEndOfStreamData => TabularTestingFactory.ExpandDynamicData(
        new[]
        {
            new object[] { "", false, "lf-1a-1b-1c" },
            new object[] { "", false, "lf-1a-1b-1b" },
    ...
    [DataTestMethod, DynamicData(nameof(MoveNextRecordWhenEndOfStreamData))]
    public async Task MoveNextRecordWhenEndOfStream(string streamScript, bool expected, string dialectScript, string encodingName)
    {
        var encoding = TabularTestingFactory.CreateEncoding(encodingName);
        var dialect = TabularTestingFactory.CreateDialect(dialectScript);
